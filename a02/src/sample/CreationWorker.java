    ...
    protected String call() throws Exception {
        ...
        if (create) {
            ...
            if (imagesFound < 0) {
                ...
                command = "ffmpeg -i ./src/creations/" + creationName + "/" + creationName + "Temp.mp4 -vf drawtext=\"fontfile=/Library/Fonts/Verdana.ttf: text='" + creationName + "': fontcolor=white: fontsize=100: x=(w-text_w)/2: y=(h-text_h)/2\" -r 25 -codec:a copy ./src/creations/" + creationName + "/" + creationName + "Text.mp4";
                Terminal.command(command);
